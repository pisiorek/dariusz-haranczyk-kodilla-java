...
public class ExtraFoodShopSupplier implements Supplier {
    ...
    public ExtraFoodShopSupplier(InformationService informationService, OrderService orderService,
    ...
    public OrderDto process(OrderRequest orderRequest) {
        ...
        if (isOrdered) {
            ...
            System.out.println("Wiadomość wysłana z metody process EXTRA FOOD SHOP");
