...
public class GlutenFreeShopSupplier implements Supplier {
    ...
    public GlutenFreeShopSupplier(InformationService informationService, OrderService orderService,
    ...
    public OrderDto process(OrderRequest orderRequest) {
        ...
        if (isOrdered) {
            ...
            System.out.println("Wiadomość wysłana z metody process Gluten Free Shop");
